...
import {
  ...
  GEMINI_DENIAL_CORRECTION_SCHEMA,
...
function getModel(): GenerativeModel | null {
  ...
  cachedModel = ai.getGenerativeModel({
    ...
    generationConfig: {
      ...
      responseSchema: GEMINI_DENIAL_CORRECTION_SCHEMA as unknown as Parameters<
...
export async function POST(req: Request) {
  ...
  const { denialText, claimContext, analysis } = parsed.data;
  ...
  const validated = DenialCorrectionSchema.safeParse(json);
